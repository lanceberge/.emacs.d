...
(use-package tab-bar
  ...
  (my-leader-def
    ...
    "tg"      #'(tab-bar-select-tab           :which-key "choose tab")
    "tn"      #'(tab-bar-switch-to-next-tab   :which-key "next tab")
    "tp"      #'(tab-bar-switch-to-prev-tab   :which-key "previous tab")
    "t SPC g" #'(tab-bar-switch-to-tab        :which-key "choose tab by name")
    "td"      #'(tab-bar-close-tab            :which-key "close tab")
    "t SPC d" #'(tab-bar-close-other-tabs     :which-key "close other tabs")
