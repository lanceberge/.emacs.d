...
(use-package emacs ; initial keybindings of built-in functions
  ...
  (my-leader-def
    ...
    "oft" (lambda () (interactive)
            (tab-bar-switch-to-tab "org")
            (find-file "~/Dropbox/org/todo.org") :which-key "todo")
...
(use-package counsel ; ivy support for many functions
  ...
  (my-leader-def
    ...
    "fio"       (lambda () (interactive) (counsel-file-jump "" "~/Dropbox/org"))
    ...
    "ofo" (lambda () (interactive)
            (tab-bar-switch-to-tab "org")
            (counsel-find-file "~/Dropbox/org") :which-key "org")
...
(use-package yasnippet ; snippets
  ...
  :custom
  (yas-snippet-dirs '("~/.emacs.d/snippets" "~/Dropbox/org/snippets"))
  :general
  (my-leader-def
...
(use-package org-capture
  ...
  (org-capture-templates
   '(("l" "Life TODO entry"
      entry (file+headline "~/Dropbox/org/todo.org" "Life")
      "*     TODO %?\n %i\n" :prepend t)

     ("e" "Emacs TODO entry"
      entry (file+headline "~/Dropbox/org/todo.org" "Emacs")
      "*     TODO %?\n %i\n" :prepend t)

     ("t" "today TODO entry"
      entry (file+headline "~/Dropbox/org/todo.org" "Today")
      "*     TODO %?\n %i\n" :prepend t)

     ("s" "school TODO"
      entry (file+headline "~/Dropbox/org/todo.org" "School")
      "*     TODO %?\n %i\n" :prepend t)

     ("d" "org drill"
      entry (file+headline "~/Dropbox/org/notes.org" "Miscellaneous")
      "* %? :drill:" :prepend t)))
  :general
  (my-leader-def
