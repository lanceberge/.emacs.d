...
(use-package dired-x
  :straight (:type built-in)) ; TODO hide ./ and ../
#+END_SRC
** Windows
#+BEGIN_SRC emacs-lisp :results none
...
(use-package eshell
  ...
  (add-hook 'eshell-post-command-hook '+eshell-init-aliases-h))
#+END_SRC
** Miscellaneous
#+BEGIN_SRC emacs-lisp :results none
...
(use-package ess
  ...
  :hook (ess-r-mode . prog-mode) ; ESS doesn't load prog-mode by default
  :general
