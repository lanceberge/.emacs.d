...
#+BEGIN_SRC emacs-lisp :results none
;; taken from: https://github.com/tedroden/dot-files/blob/master/dot-emacs.el#L529
(defun +exwm/goto-application (buffer-prefix &optional cmd)
  (let ((existing-buffer
...
(defun +exwm/goto-firefox ()
  (interactive)
  (+exwm/goto-application "firefox" "/usr/bin/firefox"))
#+END_SRC
* Completion
** Ivy
#+BEGIN_SRC emacs-lisp :results none
...
(use-package org-pomodoro
  :general
  ('org-mode-map "C-c p" #'org-pomodoro))
