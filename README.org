...
(use-package ivy ; narrowing framework
  ...
  :config
  (setq ivy-re-builders-alist '((swiper-isearch        . ivy--regex-fuzzy)
...
(use-package org
  ...
  (defvar custom-functions-list '(evil-org-open-above evil-org-open-below  org-indent-line org-return))
